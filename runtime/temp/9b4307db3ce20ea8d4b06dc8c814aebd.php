<?php /*a:2:{s:77:"/www/wwwroot/sam_zhuzhouyike_com/application/admin/view/wechat/keys_edit.html";i:1551965718;s:74:"/www/wwwroot/sam_zhuzhouyike_com/application/admin/view/public/layout.html";i:1551805875;}*/ ?>
<!doctype html>
<html>
<head>
  ...
  <div class="wrapper wrapper-content layui-anim layui-anim-up" style="padding:0 10px">
        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
            <ul class="layui-tab-title">
                <li> <a href="<?php echo url('admin/wechat/keys'); ?>">微信关键字管理</a> </li>
                <li  class="layui-this"> <a href="<?php echo url('admin/wechat/keysEdit',['act'=>'add']); ?>">添加关键字</a> </li>
            </ul>
        </div> 
        <div class="ibox-content ">
                ...
                <div class="row keys-container">
                    <div class="col-xs-6 margin-left-15">
                        <form class="form-horizontal layui-form" role="form" data-auto="true" action="/index.php/admin/Wechat/keysHandle.html" method="post" data-listen="true" novalidate="novalidate">
                        <fieldset class="layui-elem-field layui-box" style="width: 535px; height: 590px;position: absolute;">
                            <legend style="margin-left: 20px; padding: 0 10px;font-size: 20px;font-weight: 300;"> 编辑关键字回复</legend>
                            <?php if(!isset($vo['keys']) or ($vo['keys'] != 'default' and $vo['keys'] != 'subscribe')): ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <input required title='请输入关键字' maxlength='20' name='keys' style="height: auto" required lay-verify="required" class="form-control" value='<?php echo htmlentities((isset($vo['keys']) && ($vo['keys'] !== '')?$vo['keys']:"")); ?>'>
                                    </div>
                                </div>
                            <?php else: ?>
                            <?php endif; ?>
                            <input type="hidden" name="id" value="<?php echo htmlentities((isset($vo['id']) && ($vo['id'] !== '')?$vo['id']:'')); ?>">
                            <input type="hidden" name="act" value="<?php echo !empty($vo['id']) ? 'edit'  :  'add'; ?>">
                                <div class="form-group">
                                ...
                                <div class="form-group" data-keys-type='news'>
                                    ...
                                    <div class="col-xs-8">
                                        ...
                                        <input type="hidden" class='layui-input' id="news_id" value="<?php echo htmlentities((isset($vo['news_id']) && ($vo['news_id'] !== '')?$vo['news_id']:0)); ?>" name="news_id">
                                    </div>
                                </div>
                                ...
                                <div class="form-group" data-keys-type='image'>
                                    ...
                                    <div class="col-xs-8">
                                        <input type="text" class="layui-input" id="image_url" onchange="$(this).nextAll('img').attr('src', this.value);"
                                            value="<?php echo htmlentities((isset($vo['image_url']) && ($vo['image_url'] !== '')?$vo['image_url']:'/public/static/images/wechat/images.jpg')); ?>"
                                            name="image_url" required title="请上传图片或输入图片URL地址">
                                        <p class="help-block">文件最大2Mb，支持bmp/png/jpeg/jpg/gif格式</p>
                                        <img data-tips-image  id="image_url_preimg" class="img-thumbnail" src='<?php echo htmlentities((isset($vo['image_url']) && ($vo['image_url'] !== '')?$vo['image_url']:"/public/static/images/wechat/images.jpg")); ?>' style="width:120px;height: auto;border-radius: 5px;margin-top: 5px;">
                            ...
                            <div class="form-group" data-keys-type='music'>
                                ...
                                <div class="col-xs-8">
                                    <input onchange="$(this).nextAll('img').attr('src', this.value);" type="text" id="music_image" class="form-control"
                                        value="<?php echo htmlentities((isset($vo['music_image']) && ($vo['music_image'] !== '')?$vo['music_image']:'public/static/images/wechat/images.jpg')); ?>"
                                        name="music_image" required title="请上传音乐图片或输入音乐图片URL地址　　">
                                    <p class="help-block">文件最大64KB，只支持JPG格式</p>
                                    <img data-tips-image  id="music_image_preimg" src='<?php echo htmlentities((isset($vo['music_image']) && ($vo['music_image'] !== '')?$vo['music_image']:"/public/static/images/wechat/images.jpg")); ?>' style="width:120px;height: auto;border-radius: 5px;margin-top: 5px;">
