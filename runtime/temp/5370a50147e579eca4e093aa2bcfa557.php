<?php /*a:2:{s:71:"/www/wwwroot/sam_zhuzhouyike_com/application/admin/view/shop/index.html";i:1553687578;s:74:"/www/wwwroot/sam_zhuzhouyike_com/application/admin/view/public/layout.html";i:1551805875;}*/ ?>
...
<body style="background-color: rgb(255, 255, 255); overflow: auto; cursor: default; -moz-user-select: inherit;">
        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                <ul class="layui-tab-title">
                  ...
                  <li><a  href="<?php echo url('admin/shop/add',['act'=>'add']); ?>">新增</a></li>
    ...
    <script>
        $(document).ready(function(){
            ...
            var tableIns = table.render({
                ...
                ,toolbar: '#toolbarDemo'
                ,title: '用户数据表'
                ,cols: [[{"type":"checkbox","fixed":"left"},{"field":"name","title":"名字","align":"center","sort":false,"edit":"text"},{"field":"email","title":"右键","align":"center","sort":false,"edit":""},{"fixed":"right","right":"操作","toolbar":"#barDemo"}]]
                ,page: true
              ...
              table.on('tool(shop)', function(obj){
                ...
                if(obj.event === 'del'){
                  layer.confirm('确定删除么', function(index){
                    $.post("<?php echo url('admin/shop/Handle'); ?>",{id:data.id,'act':'del','auth_code':"<?php echo htmlentities(app('config')->get('AUTH_CODE')); ?>"},function(res){
                      if(res.code == 1){
                    ...
                    var id  = data.id;
                    window.location.href = "/admin/shop/add/act/edit/id/"+id;
                }
              });
            });
                    // 表格行点击选中切换
