<?php /*a:2:{s:77:"/www/wwwroot/sam_zhuzhouyike_com/application/admin/view/admin/admin_info.html";i:1548730589;s:74:"/www/wwwroot/sam_zhuzhouyike_com/application/admin/view/public/layout.html";i:1551805875;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="layui-row" style="margin-top: 15px">
                <form class="form-horizontal" id="adminHandle" method="post">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="email"   id="email" value="<?php echo htmlentities((isset($info['email']) && ($info['email'] !== '')?$info['email']:'')); ?>" required  lay-verify="required"  autocomplete="off" class="layui-input">    
                                ...
                                <div class="layui-input-inline">
                                    <select name="role_id" id="role" lay-ignore class="layui-select">
                                            <?php if(is_array($role) || $role instanceof \think\Collection || $role instanceof \think\Paginator): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                                                <option value="<?php echo htmlentities($item['role_id']); ?>" <?php if(!empty($info['role_id']) && $item['role_id'] == $info['role_id']): ?>seleced<?php endif; ?>><?php echo htmlentities($item['role_name']); ?></option>
