<?php /*a:2:{s:77:"/www/wwwroot/sam_zhuzhouyike_com/application/admin/view/article/category.html";i:1548841100;s:74:"/www/wwwroot/sam_zhuzhouyike_com/application/admin/view/public/layout.html";i:1551805875;}*/ ?>
<!doctype html>
<html>
<head>
                                    ...
                                    <div class="layui-input-inline">
                                        ...
                                        <option value="0">顶级分类</option>
                                            <?php if(is_array($cat_select) || $cat_select instanceof \think\Collection || $cat_select instanceof \think\Paginator): $i = 0; $__LIST__ = $cat_select;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                                <option value="<?php echo htmlentities($v['cat_id']); ?>"   <?php if(!empty($parent_id) && $parent_id == $v['cat_id']): ?>selected<?php endif; ?>><?php if($v['level'] > '0'): for($i=0;$i<$v['level'];$i++){echo ' &nbsp;&nbsp;&nbsp;&nbsp;';} ?><?php endif; ?><?php echo htmlentities($v['cat_name']); ?></option>
