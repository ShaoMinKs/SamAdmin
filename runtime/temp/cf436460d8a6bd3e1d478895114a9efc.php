<?php /*a:2:{s:69:"/www/wwwroot/sam_zhuzhouyike_com/application/shop/view/index/add.html";i:1553686187;s:73:"/www/wwwroot/sam_zhuzhouyike_com/application/shop/view/public/layout.html";i:1553686003;}*/ ?>
...
<body style="background-color: #FFF; overflow: auto;">
    <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
        <ul class="layui-tab-title">
            <li> <a href="<?php echo url('shop/index/index'); ?>">列表</a> </li>
            <li class="layui-this"><a  href="<?php echo url('shop/index/add'); ?>"><?php echo !empty($info['id']) ? '编辑'  :  '新增'; ?></a></li>
    ...
    <div class="layui-tab-content">
                <div class="layui-row">
                    <form class="layui-form" action="<?php echo url('shop/index/Handle'); ?>" method="post">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label" for="email"><span class="c-red">*</span>邮箱：</label>
                                <div class="layui-input-inline">
                                    <input type="text" class="layui-input" placeholder="邮箱" lay-verify="emial" name="email" value="<?php echo isset($info['email']) ? htmlentities($info['email']) : ''; ?>" >
                                </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label" for="address"><span class="c-red">*</span>地址：</label>
                                <div class="layui-input-inline">
                                    <input type="text" class="layui-input" placeholder="地址" lay-verify="require" name="address" value="<?php echo isset($info['address']) ? htmlentities($info['address']) : ''; ?>" >
                                </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label" for="phone"><span class="c-red">*</span>手机：</label>
                                <div class="layui-input-inline">
                                    <input type="number" class="layui-input" placeholder="手机" lay-verify="required|phone|number" name="phone" value="<?php echo isset($info['phone']) ? htmlentities($info['phone']) : ''; ?>" >
                                </div>
                        </div>
