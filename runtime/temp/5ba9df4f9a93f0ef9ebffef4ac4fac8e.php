<?php /*a:2:{s:78:"/www/wwwroot/sam_zhuzhouyike_com/application/admin/view/system/right_list.html";i:1547229975;s:74:"/www/wwwroot/sam_zhuzhouyike_com/application/admin/view/public/layout.html";i:1551805875;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page" style="padding-top:10px">
	<div class="flexigrid">
        ...
        <div class="demoTable" style="margin-top:10px">
                ...
                <a class="layui-btn" href="<?php echo url('admin/system/edit_right'); ?>"> <i class="fa fa-plus"></i> 新增权限</a>
        </div>	
        <div>                   
...
var tableIns = table.render({
    elem: '#test'
    ,url:"<?php echo url('admin/system/ajaxGetRight'); ?>"
    ,toolbar: '#toolbarDemo'
    ,title: '用户数据表'
    ,cols: [[
  ...
  table.on('tool(test)', function(obj){
    ...
    if(obj.event === 'del'){
      layer.confirm('确定删除么', function(index){
        ...
        var id  = data.id;
        window.location.href = "/admin/system/edit_right/id/"+id;
    }
  });
});
		// 表格行点击选中切换
