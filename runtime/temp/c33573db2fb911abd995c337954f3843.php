<?php /*a:2:{s:85:"D:\phpstudy\PHPTutorial\WWW\SamAdmin\application\admin\view\article\article_list.html";i:1575379551;s:78:"D:\phpstudy\PHPTutorial\WWW\SamAdmin\application\admin\view\public\layout.html";i:1575380244;}*/ ?>
<!doctype html>
<html>
<head>
...
<body style="background-color: rgb(255, 255, 255); overflow: auto; cursor: default; -moz-user-select: inherit;">
  <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
      <ul class="layui-tab-title">
        <li class="layui-this">文章列表 <span style="font-size:12px;color:#777">(共<?php echo htmlentities($count); ?>条记录)</span></li>
        <li><a  href="<?php echo url('admin/article/article'); ?>">新增文章</a></li>
...
var tableIns = table.render({
    elem: '#test'
    ,url:"<?php echo url('admin/article/getArticles'); ?>"
    ,toolbar: '#toolbarDemo'
    ,title: '用户数据表'
    ,cols: [[
  ...
  table.on('tool(test)', function(obj){
    ...
    if(obj.event === 'del'){
      layer.confirm('确定删除么', function(index){
        $.post("<?php echo url('admin/article/articleHandle'); ?>",{id:data.article_id,'act':'del','auth_code':"<?php echo htmlentities(app('config')->get('AUTH_CODE')); ?>"},function(res){
          if(res.code == 1){
            layer.msg(res.msg,{icon: 2,time: 1000})
            obj.del();
            layer.close(index);
