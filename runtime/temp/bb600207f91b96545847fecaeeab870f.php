<?php /*a:2:{s:71:"/www/wwwroot/sam_zhuzhouyike_com/application/admin/view/curd/index.html";i:1554708593;s:74:"/www/wwwroot/sam_zhuzhouyike_com/application/admin/view/public/layout.html";i:1551805875;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="layui-row">
                <form class="layui-form" action="<?php echo url('admin/curd/run'); ?>" method="post">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" required lay-verify="require" class="layui-input" name="table_name" placeholder="表名，不填则默认为控制器名">    
                        </div>
                    </div>
                    <table class="layui-table">
                            <thead>
