<?php /*a:2:{s:77:"/www/wwwroot/sam_zhuzhouyike_com/application/admin/view/article/linkList.html";i:1551083916;s:74:"/www/wwwroot/sam_zhuzhouyike_com/application/admin/view/public/layout.html";i:1551805875;}*/ ?>
<!doctype html>
<html>
<head>
...
<body style="background-color: rgb(255, 255, 255); overflow: auto; cursor: default; -moz-user-select: inherit;">
        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                <ul class="layui-tab-title">
                  <li class="layui-this">链接列表 <span style="font-size:12px;color:#777">(共<?php echo htmlentities($counts); ?>条记录)</span></li>
                  <li><a  href="<?php echo url('admin/article/link',['act'=>'add']); ?>">新增链接</a></li>
    ...
    <script>
        $(document).ready(function(){
            ...
            var tableIns = table.render({
                elem: '#link'
                ,url:"<?php echo url('admin/article/getlinks'); ?>"
                ,toolbar: '#toolbarDemo'
                ,title: '用户数据表'
                ,cols: [[
              ...
              table.on('tool(link)', function(obj){
                ...
                if(obj.event === 'del'){
                  layer.confirm('确定删除么', function(index){
                    $.post("<?php echo url('admin/article/linkHandle'); ?>",{link_id:data.link_id,'act':'del','auth_code':"<?php echo htmlentities(app('config')->get('AUTH_CODE')); ?>"},function(res){
                      if(res.code == 1){
                        layer.msg(res.msg,{icon: 2,time: 1000})
                        obj.del();
                        layer.close(index);
