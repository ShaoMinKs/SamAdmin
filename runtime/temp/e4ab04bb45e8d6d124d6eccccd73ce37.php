<?php /*a:2:{s:72:"/www/wwwroot/sam_zhuzhouyike_com/application/admin/view/admin/index.html";i:1547088423;s:74:"/www/wwwroot/sam_zhuzhouyike_com/application/admin/view/public/layout.html";i:1551805875;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page" style="padding-top:10px">
	<div class="flexigrid">
		<div class="mDiv">
			<div class="ftitle">
				<h3>管理员列表</h3>
				<h5>(共<?php echo htmlentities(count($list)); ?>条记录)</h5>
			</div>
        ...
        <div class="demoTable" style="margin-top:10px">
                ...
                <a class="layui-btn" href="<?php echo url('admin/admin/admin_info'); ?>"> <i class="fa fa-plus"></i> 新增管理员</a>
        </div>	
        <div>                   
...
var tableIns = table.render({
    elem: '#test'
    ,url:"<?php echo url('admin/admin/getAdmin'); ?>"
    ,toolbar: '#toolbarDemo'
    ,title: '用户数据表'
    ,cols: [[
