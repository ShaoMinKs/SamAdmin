<?php /*a:1:{s:84:"D:\phpstudy\PHPTutorial\WWW\SamAdmin\application\admin\view\public\form-builder.html";i:1575379551;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	<title><?=$form->getTitle()?></title>
    <script src="/public/plugins/vue/dist/vue.min.js"></script>
    <link href="/public/plugins/iview/dist/styles/iview.css" rel="stylesheet">
    <script src="/public/plugins/iview/dist/iview.min.js"></script>
    <script type="text/javascript" src="/public/static/js/jquery.js"></script>
    <script src="/public/plugins/form-create/province_city.js"></script>
    <script src="/public/plugins/form-create/form-create.min.js"></script>
    <style>
        /*弹框样式修改*/
