<?php /*a:1:{s:76:"D:\phpstudy\PHPTutorial\WWW\SamAdmin\application\admin\view\admin\login.html";i:1575379551;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <form action="" name='theForm' id="theForm" method="post">
            <div class="login-form" style="position: relative">
                <div class="formContent">
                    ...
                    <p style="text-align:center">体验账号 demo 密码 123456</p>
                    <div class="formInfo">
                    	<div class="formText">
                        ...
                        <div class="formText">
                            ...
                            <img src="<?php echo url('Admin/verify'); ?>" class="chicuele" id="imgVerify" alt="" onclick="fleshVerify()" style="vertical-align: inherit;">
                        </div>
                        <div class="formText">
                        	<!--<div class="checkbox">
                            	<div class="cur">
						...
						<div class="formText submitDiv">
                          <span class="submit_span">
                          	<input type="button" name="submit" class="sub" value="登 录" style="border-radius: 0" >
                          </span>
                       </div>
                    </div>
                </div>
